...
# Context
- 新 Placement 的名稱: 
  - ex: `gliaaffiliate_beaulace`
- 要依照此 Placement 的設定 (optional):
  - ex: `https://gstudio.gliacloud.com/admin/ad/placement/845/change/` 
- adtag_url 格式組合（可照預設）:
  - default: `https://player.gliacloud.com/vast/GAM_CREATIVE?video={video}&click={click}` 
- video url:
- click url: 
- retargeting rule:
  - 文字說明，或要仿照某個 adunit 的 retargeting_rule 可以貼那個 adunit 的 url
  - ex: `已看過首頁 + 滯留 5 秒`
- 要加進 placement 的 slots: 
